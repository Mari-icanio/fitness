...
const findUser = async (req, res) => {
    ...
    try {
        ...
        const accessToken = jwt.sign({ userId: existingUser._id }, 'your_access_token_secret', { expiresIn: '1h' });

        // Generate refresh token
        const refreshToken = jwt.sign({ userId: existingUser._id }, 'your_refresh_token_secret', { expiresIn: '7d' });
